...
function submitLoanForm() {
    ...
    var number = document.getElementById("number");
    var permission;
    for (var i = 0; i < document.getElementsByClassName("permissionRadio").length; i++) {
        var permissionRadio = document.getElementsByClassName("permissionRadio")[i];
        if (permissionRadio.checked) {
            permission = i;
        }
    }
    var a = confirm("Freigabe erteilen?\n\nName: " + name.value +
    ...
    if (a) {
        var tr = new Transponder(document.getElementsByClassName("transponderID")[permission].innerHTML, true);
